...
partial class Program
{
    ...
    static void GetRandomProducts()
    {
        using (Northwind db = new())
        {
            Sectiontitle("Get Random Products");
    ...
    //Loads
    //Eager Loading: Load data early -> load all entities at start. -> all loaded, memory exess
    //Lazy Loading:  Load data automaticlly just before its needed. ->Memory efficient, if table is big enough it delays
